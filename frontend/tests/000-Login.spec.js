...
// Check if the storageState.json file exists, if not, create it.
if (!fs.existsSync(stateFile)) {
	// Optionally, create an empty object or initialize it with a default structure
	fs.writeFileSync(stateFile, JSON.stringify({}));
}

test.describe.skip("Login and Setup Process", () => {
	test("Login Test + Setup with Stealth", async ({ page, context }) => {
